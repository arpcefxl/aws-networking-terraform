module "us_east_1_security_groups" {
  ...
  local_vpc_cidr  = data.terraform_remote_state.us_east_1_uberads_remote.outputs.us_east_1_vpc_cidr
  remote_vpc_cidr = [
    data.terraform_remote_state.us_west_2_uberads_remote.outputs.us_west_2_vpc_cidr
  ]
  ...
  mongodb_cidr    = concat(data.terraform_remote_state.us_east_1_uberads_remote.outputs.us_east_1_vpc_mongodb_cidr)
